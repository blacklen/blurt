...
| **Random** | Eight game modes (Shuffle, Burst, Boss, Wager, Capsule, Full sentence, Dictation, Sounds right?) that drill your saved chunks without touching the SRS schedule. **Sounds right?** shows two sentences and you tap the natural one; pairs come from your own old answers and their fixes first, then from a chunk with an AI-made slip. |
